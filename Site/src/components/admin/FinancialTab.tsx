            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className="flex overflow-x-auto gap-4 pb-4 no-scrollbar -mx-4 px-4 sm:mx-0 sm:px-0 flex-nowrap">
                        <div className="min-w-[160px] md:min-w-[200px] flex-1 bg-white border text-left border-slate-200 rounded-3xl p-6 shadow-sm relative overflow-hidden flex items-center justify-between">
                            <div>
                            ...
                            <div className="w-8 h-8 md:w-10 md:h-10 bg-blue-100/50 text-blue-600 rounded-2xl flex items-center justify-center shrink-0"><DollarSign className="w-5 h-5" /></div>
                        </div>
                        <div className="min-w-[160px] md:min-w-[200px] flex-1 bg-white border text-left border-slate-200 rounded-3xl p-6 shadow-sm flex items-center justify-between">
                            <div>
                            ...
                            <div className="w-8 h-8 md:w-10 md:h-10 bg-red-100/50 text-red-600 rounded-2xl flex items-center justify-center shrink-0"><AlertCircle className="w-5 h-5" /></div>
                        </div>
                        <div className="min-w-[160px] md:min-w-[200px] flex-1 bg-white border text-left border-slate-200 rounded-3xl p-6 shadow-sm flex items-center justify-between">
                            <div>
                            ...
                            <div className="w-8 h-8 md:w-10 md:h-10 bg-emerald-100/50 text-emerald-600 rounded-2xl flex items-center justify-center shrink-0"><TrendingUp className="w-5 h-5" /></div>
                        </div>
                        <div className="min-w-[160px] md:min-w-[200px] flex-1 bg-white border text-left border-slate-200 rounded-3xl p-6 shadow-sm flex items-center justify-between">
                            <div>
                            ...
                            <div className="w-8 h-8 md:w-10 md:h-10 bg-indigo-100/50 text-indigo-600 rounded-2xl flex items-center justify-center shrink-0"><DollarSign className="w-5 h-5" /></div>
                        </div>
                    </div>
